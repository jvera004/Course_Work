...
public partial class _default : System.Web.UI.Page
{
    ...
    public int duplicateCount(String fileName)
    {
        ...
        DirectoryInfo FilesDirectory = new DirectoryInfo(Server.MapPath("~/Files/"));
        ...
        if (FileUploadOptionBox.HasFile)
        {
            try
            {
                ...
                if (checkForDuplicates(fileName))
                    FileUploadOptionBox.SaveAs(Server.MapPath("~/Files/") + fileName + "_" + (duplicateCount(fileName)));
                else
                {
                    FileUploadOptionBox.SaveAs(Server.MapPath("~/Files/") + fileName);
