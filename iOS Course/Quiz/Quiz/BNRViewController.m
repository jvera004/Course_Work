...
- (IBAction)showQuestion:(id)sender 
{
	...
	//Update the total questions asked counter
    //Put it into a NSString
	totalQuestionsAsked++;
    NSString *questionsTotal = [NSString stringWithFormat:@"%i",totalQuestionsAsked];
	...
	//Update the total questions shown label with the total questions asked counter
	[totalQuestionsAskedLabel setText:questionsTotal];
...
- (IBAction)showAnswer:(id)sender 
{
	...
	//Update the total answers shown counter
    //Put it into a new NSString
	totalAnswersShown++;
    NSString *answersTotal = [NSString stringWithFormat:@"%i",totalAnswersShown];
    
    // Display the answer string in the answer text field
    [answerField setText:answer];
	

	//Update the total answers shown label with the total answers shown counter
	[totalAnswersShownLabel setText:answersTotal];
}
@end
